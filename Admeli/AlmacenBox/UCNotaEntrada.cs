    ...
    public partial class UCNotaEntrada : UserControl
    {
        ...
        private async void cargarRegistroslike()
        {
            ...
            try
            {
                ...
                RootObject<NotaEntrada> rootData = await notaEntradaModel.notaEntradasLIKE(sucursalId, almacenId, personalId, estado, paginacion.currentPage, paginacion.speed, txtBuscar.Text.Trim());
                if (rootData.nro_registros == 0)
                {
