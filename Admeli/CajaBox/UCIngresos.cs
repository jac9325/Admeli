    ...
    public partial class UCIngresos : UserControl
    {
        ...
        private async void cargarPersonales()
        {
            try
            {
                if (ConfigModel.asignacionPersonal.idPuntoGerencia == 0 && ConfigModel.asignacionPersonal.idPuntoAdministracion == 0)
                {
                    ...
                    dataGridView.Columns["personal"].Visible = false;
                }
                else
                {
        ...
        private async void cargarRegistros()
        {
            ...
            try
            {
                ...
                RootObject<Ingreso> ingresoRoot = await ingresoModel.ingresos(sucursalId, personalId, idCajaSesion, estado, paginacion.currentPage, paginacion.speed, buscar);
