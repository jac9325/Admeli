...
namespace Admeli.Compras.Nuevo
{
    public partial class FormCompraN : Form
    {
        ...
        private void FormCompraNew_Load(object sender, EventArgs e)
        {
            ...
            lblMensaje.Text = "(Se deshabilita cuando la" + Environment.NewLine + "Caja no está Iniciada)";
        ...
        private void reLoad()
        {
            ...
            {
                chbxPagarCompra.Enabled = true;
                chbxPagarCompra.Checked = true;
            }
        ...
        private async void hacerCompra()
        {
            ...
            try
            {
                ...
                //notaentrada.generarNotaEntrada = chbxPagarCompra.Checked == true ? 1 : 0;//-- modificado
       ...
       private void importarOrdenCompra()
        ...
        private async void cbxTipoDocumento_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (cbxTipoDocumento.SelectedIndex == 1) { calculoSubtotal(); }
            if (cbxTipoDocumento.SelectedIndex == 2) { calculoSubtotal(); }
            if (cbxTipoDocumento.SelectedIndex == 3) return;
            try
            {
                ...
                Moneda moneda1 = monedas.Find(X => X.idMoneda == (int)cbxTipoMoneda.SelectedValue);
                this.subTotal = subTotalLocal;

                lbSubtotal.Text = moneda1.simbolo + ". " + darformato(subTotalLocal);
                // determinar impuesto de cada producto
                ...
                lbImpuesto.Text = moneda1.simbolo + ". " + darformato(impuesto);

                // determinar impuesto de cada producto
                this.total = impuesto + subTotalLocal;
                lbTotalCompra.Text = moneda1.simbolo + ". " + darformato(total);
